...
proto.evrynet.GetWhitelistAssetsResponse = function(opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.evrynet.GetWhitelistAssetsResponse.repeatedFields_,
    null,
  )
}
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.evrynet.GetWhitelistAssetsResponse.displayName =
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.evrynet.GetBalanceRequest.displayName =
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.evrynet.GetBalanceResponse.displayName =
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.evrynet.GetNonceRequest.prototype.toObject = function(
    opt_includeInstance,
  ) {
 ...
 * @return {!proto.evrynet.GetNonceRequest}
 */
proto.evrynet.GetNonceRequest.deserializeBinaryFromReader = function(
  msg,
  reader,
) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.evrynet.GetNonceRequest.serializeBinaryToWriter = function(
  message,
  writer,
) {
  var f = undefined
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.evrynet.GetNonceResponse.prototype.toObject = function(
    opt_includeInstance,
  ) {
 ...
 * @return {!proto.evrynet.GetNonceResponse}
 */
proto.evrynet.GetNonceResponse.deserializeBinaryFromReader = function(
  msg,
  reader,
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.evrynet.GetNonceResponse.serializeBinaryToWriter = function(
  message,
  writer,
) {
  var f = undefined
 ...
 * @const
 */
proto.evrynet.GetWhitelistAssetsResponse.repeatedFields_ = [2, 3]
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.evrynet.GetWhitelistAssetsResponse.prototype.toObject = function(
    opt_includeInstance,
  ) {
    return proto.evrynet.GetWhitelistAssetsResponse.toObject(
      opt_includeInstance,
      this,
    )
  }
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.evrynet.GetWhitelistAssetsResponse.toObject = function(
    includeInstance,
    msg,
  ) {
    var f,
      obj = {
        nativeasset:
          (f = msg.getNativeasset()) &&
          src_modules_warp_common_pb.Asset.toObject(includeInstance, f),
        stellarcreditList: jspb.Message.toObjectList(
          msg.getStellarcreditList(),
          src_modules_warp_common_pb.Asset.toObject,
          includeInstance,
        ),
        evrynetcreditList: jspb.Message.toObjectList(
          msg.getEvrynetcreditList(),
          src_modules_warp_common_pb.Asset.toObject,
          includeInstance,
        ),
      }
...
proto.evrynet.GetWhitelistAssetsResponse.deserializeBinary = function(bytes) {
  ...
  return proto.evrynet.GetWhitelistAssetsResponse.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.evrynet.GetWhitelistAssetsResponse}
 */
proto.evrynet.GetWhitelistAssetsResponse.deserializeBinaryFromReader = function(
  msg,
  reader,
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        ...
        reader.readMessage(
          value,
          src_modules_warp_common_pb.Asset.deserializeBinaryFromReader,
        )
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.evrynet.GetWhitelistAssetsResponse.serializeBinaryToWriter = function(
  message,
  writer,
) {
  var f = undefined
  ...
  f = message.getStellarcreditList()
  if (f.length > 0) {
  ...
  f = message.getEvrynetcreditList()
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      3,
      f,
...
proto.evrynet.GetWhitelistAssetsResponse.prototype.getNativeasset = function() {
  return /** @type{?proto.common.Asset} */ (jspb.Message.getWrapperField(
    this,
    src_modules_warp_common_pb.Asset,
    1,
  ))
}
 ...
 */
proto.evrynet.GetWhitelistAssetsResponse.prototype.setNativeasset = function(
  value,
) {
 ...
 */
proto.evrynet.GetWhitelistAssetsResponse.prototype.getStellarcreditList = function() {
  return /** @type{!Array<!proto.common.Asset>} */ (jspb.Message.getRepeatedWrapperField(
    this,
    src_modules_warp_common_pb.Asset,
    2,
  ))
 ...
 * @return {!proto.evrynet.GetWhitelistAssetsResponse} returns this
 */
proto.evrynet.GetWhitelistAssetsResponse.prototype.setStellarcreditList = function(
  value,
) {
 ...
 * @return {!proto.common.Asset}
 */
proto.evrynet.GetWhitelistAssetsResponse.prototype.addStellarcredit = function(
  opt_value,
  opt_index,
) {
 ...
 * @return {!proto.evrynet.GetWhitelistAssetsResponse} returns this
 */
proto.evrynet.GetWhitelistAssetsResponse.prototype.clearStellarcreditList = function() {
  return this.setStellarcreditList([])
}
 ...
 * @return {!Array<!proto.common.Asset>}
 */
proto.evrynet.GetWhitelistAssetsResponse.prototype.getEvrynetcreditList = function() {
  return /** @type{!Array<!proto.common.Asset>} */ (jspb.Message.getRepeatedWrapperField(
    this,
    src_modules_warp_common_pb.Asset,
    3,
 ...
 * @return {!proto.evrynet.GetWhitelistAssetsResponse} returns this
 */
proto.evrynet.GetWhitelistAssetsResponse.prototype.setEvrynetcreditList = function(
  value,
) {
 ...
 * @return {!proto.common.Asset}
 */
proto.evrynet.GetWhitelistAssetsResponse.prototype.addEvrynetcredit = function(
  opt_value,
  opt_index,
) {
  return jspb.Message.addToRepeatedWrapperField(
 ...
 * @return {!proto.evrynet.GetWhitelistAssetsResponse} returns this
 */
proto.evrynet.GetWhitelistAssetsResponse.prototype.clearEvrynetcreditList = function() {
  return this.setEvrynetcreditList([])
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.evrynet.GetBalanceRequest.prototype.toObject = function(
    opt_includeInstance,
  ) {
...
proto.evrynet.GetBalanceRequest.deserializeBinary = function(bytes) {
  ...
  return proto.evrynet.GetBalanceRequest.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.evrynet.GetBalanceRequest}
 */
proto.evrynet.GetBalanceRequest.deserializeBinaryFromReader = function(
  msg,
  reader,
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.evrynet.GetBalanceRequest.serializeBinaryToWriter = function(
  message,
  writer,
) {
  var f = undefined
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.evrynet.GetBalanceResponse.prototype.toObject = function(
    opt_includeInstance,
  ) {
...
proto.evrynet.GetBalanceResponse.deserializeBinary = function(bytes) {
  ...
  return proto.evrynet.GetBalanceResponse.deserializeBinaryFromReader(
    msg,
    reader,
  )
}
 ...
 * @return {!proto.evrynet.GetBalanceResponse}
 */
proto.evrynet.GetBalanceResponse.deserializeBinaryFromReader = function(
  msg,
  reader,
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.evrynet.GetBalanceResponse.serializeBinaryToWriter = function(
  message,
  writer,
) {
  var f = undefined
