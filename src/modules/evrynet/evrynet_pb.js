...
proto.evrynet.GetWhitelistAssetsResponse.serializeBinaryToWriter = function(
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      warp_common_pb.Asset.serializeBinaryToWriter,
    )
  }
}
...
proto.evrynet.GetWhitelistAssetsResponse.prototype.setAssetsList = function(
  value,
) {
 ...
 */
proto.evrynet.GetWhitelistAssetsResponse.prototype.addAssets = function(
  opt_value,
  opt_index,
) {
