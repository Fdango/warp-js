...
export default class Warp {
  constructor() {
    ...
    this.client = {
      stellar: getStellarClient(rootConfigInstance),
      evry: getEvryClient(rootConfigInstance),
      transfer: getTransferClient(rootConfigInstance),
    }
    this.contract = {
      warp: getWarpContract(rootConfigInstance),
    }
  }
